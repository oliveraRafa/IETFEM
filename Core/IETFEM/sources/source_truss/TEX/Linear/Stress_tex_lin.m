...
if Lenguage == 1
  ...
  fprintf( fidout_tex , '%slfoot{%sfootnotesize Linear Stress}      \n','\','\') 
  fprintf( fidout_tex , '%srfoot{Page %sthepage}                        \n','\','\')
elseif Lenguage == 2
  fprintf( fidout_tex , '%slhead{Nombre del proyecto}                  \n','\')
  fprintf( fidout_tex , '%slfoot{%sfootnotesize Tensión Lineal}      \n','\','\') 
...
if Lenguage == 1
	fprintf( fidout_tex , '================== Linear Stress IETFEM v%s ===========================%s\n\n\n',version,'\\\\')
	...
	fprintf( fidout_tex , '%sbegin{center}                                   \n','\')
	fprintf( fidout_tex , '%sbegin{longtable}{|R{1.5cm}|R{2.6cm}|}                      \n','\')
...
elseif Lenguage == 2
	fprintf( fidout_tex , '================== Tensión Lineal IETFEM v%s ===========================%s\n\n\n',version,'\\\\')
...
fclose(fidout_tex) ;
tiempo_sigma_tex_lin = toc ;
tiempo_TEX = tiempo_TEX + tiempo_sigma_tex_lin;
