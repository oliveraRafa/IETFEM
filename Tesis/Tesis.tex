...
\section {Resultados obtenidos}
	...
	\subsection {Casos de prueba}
		...
		El primer caso a probar constituye la estructura de una pequeña torre. La misma se asemeja a las estructuras que se dictan en el curso de elasticidad al que se apunta. Cuenta con 10 nodos y 25  barras, en el anexo 4 se adjunta el archivo guardado con dicha estructura.
		...
		Lo primero que se observó al cargar el modelo en la interfaz, fue una notoria baja calidad en el movimiento en la cámara. Debido a la masividad de objetos ingresados en la escena, el renderizado consumía demasiado tiempo y le quitaba fluidez a la aplicación. De esta manera, se incursó en realizar mejoras de performance, de manera de no solo mejorar este caso si no de realizar una interfaz mas eficiente.
		
		
		
		Se logró de esta manera mejorar la performance hasta un nivel aceptable de visibilidad, aunque no con tanta fluidez como en casos anteriores.
