...
\section {Presentación de la solución}
	...
	Basándonos en esta realidad, se definieron los siguientes casos de uso:
        ...
        \item \textbf{Alta, Baja y Modificación de Barras:} Cada barra tiene asignado un nodo inicial, un nodo final, un material y una sección.
				\item \textbf{Alta y Baja de Grillas:} Son "`cuadrículas"' auxiliares que facilitan el proceso de dibujado. Para cada coordenada se define la cantidad de líneas auxiliares y la separación entre ellas.
	...
	\subsection {Arquitectura}
		...
		Cómo se puede ver en la Figura \ref{fig:Components}, se agruparon los casos de uso relacionados con el fin de crear diferentes subsistemas encargados de realizar cierto tipo de funcionalidades. Cada una de estas componentes, ofrece al usuario diferetes operaciones que afectan tanto el modelo de la estructura que se mantiene almacenado en la aplicación como lo que se está viendo en el espacio 3D. Por tal motivo, se crearon las componentes "`Modelo"' y "`Escena"', las cuáles uniformizan todas las operaciones básicas que se hacen en el modelo de la estructura, y en el dibujo en la escena, respectivamente. 
		
		mostrar la arquitectura mediante diagramas de distribucion de componentes y fisicas
